...
- [libbz2-dev](https://github.com/lvaccaro/libbz2-dev)
- [libcppunit-dev](https://github.com/lvaccaro/libcppunit-dev)
- [libcurl4-openssl-dev](https://github.com/lvaccaro/libcurl4-openssl-dev)
- [libffi-dev](https://github.com/lvaccaro/libffi-dev)
- [libfmt-dev](https://github.com/lvaccaro/libfmt-dev)
- [libgdbm-dev](https://github.com/lvaccaro/libgdbm-dev)
- [libglib2.0-dev](https://github.com/lvaccaro/libglib2.0-dev)
- [libglib2.0-dev-bin](https://github.com/lvaccaro/libglib2.0-dev-bin)
- [libgmp-dev](https://github.com/lvaccaro/libgmp-dev)
- [libgspell-1-dev](https://github.com/lvaccaro/libgspell-1-dev)
- [libgtkmm-3.0-dev](https://github.com/lvaccaro/libgtkmm-3.0-dev)
- [libgtksourceviewmm-3.0-dev](https://github.com/lvaccaro/libgtksourceviewmm-3.0-dev)
- [liblog4cpp5-dev](https://github.com/lvaccaro/liblog4cpp5-dev)
- [libncurses5-dev](https://github.com/lvaccaro/libncurses5-dev)
- [libnss3-dev](https://github.com/lvaccaro/libnss3-dev)
...
- [libtool](https://github.com/lvaccaro/libtool)
- [libuchardet-dev](https://github.com/lvaccaro/libuchardet-dev)
- [libxml2](https://github.com/lvaccaro/libxml2)
- [libxml++2.6-dev](https://github.com/lvaccaro/libxml++2.6-dev)
- [libxml2-dev](https://github.com/lvaccaro/libxml2-dev)
- [libxslt1-dev](https://github.com/lvaccaro/libxslt1-dev)
- [zlib1g-dev](https://github.com/lvaccaro/zlib1g-dev)

* * *

#### Common tools

- [apache2](https://github.com/lvaccaro/apache2)
- [asciinema](https://github.com/lvaccaro/asciinema)
- [autoconf](https://github.com/lvaccaro/autoconf)
- [autopsy](https://github.com/lvaccaro/autopsy)
- [binutils](https://github.com/lvaccaro/binutils)
- [binwalk](https://github.com/lvaccaro/binwalk)
- [build-essential](https://github.com/lvaccaro/build-essential)
- [cmake](https://github.com/lvaccaro/cmake)
- [curl](https://github.com/lvaccaro/curl)
- [debootstrap](https://github.com/lvaccaro/debootstrap)
- [default-jre](https://github.com/lvaccaro/default-jre)
- [dirmngr](https://github.com/lvaccaro/dirmngr)
- [dkms](https://github.com/lvaccaro/dkms)
- [doxygen](https://github.com/lvaccaro/doxygen)
- [easytag](https://github.com/lvaccaro/easytag)
- [filezilla](https://github.com/lvaccaro/filezilla)
- [g++](https://github.com/lvaccaro/g++)
- [gcc](https://github.com/lvaccaro/gcc)
- [gconf2](https://github.com/lvaccaro/gconf2)
- [ghex](https://github.com/lvaccaro/ghex)
- [git](https://github.com/lvaccaro/git)
- [gnuradio](https://github.com/lvaccaro/gnuradio)
- [gnuradio-dev](https://github.com/lvaccaro/gnuradio-dev)
- [gpg](https://github.com/lvaccaro/gpg)
- [gr-osmosdr](https://github.com/lvaccaro/gr-osmosdr)
- [hexedit](https://github.com/lvaccaro/hexedit)
- [httrack](https://github.com/lvaccaro/httrack)
- [jq](https://github.com/lvaccaro/jq)
- [kate](https://github.com/lvaccaro/kate)
- [keepassxc](https://github.com/lvaccaro/keepassxc)
- [macchanger](https://github.com/lvaccaro/macchanger)
- [make](https://github.com/lvaccaro/make)
- [mtools](https://github.com/lvaccaro/mtools)
- [net-tools](https://github.com/lvaccaro/net-tools)
- [openvpn](https://github.com/lvaccaro/openvpn)
- [pidgin](https://github.com/lvaccaro/pidgin)
- [pkg-config](https://github.com/lvaccaro/pkg-config)
- [proxychains](https://github.com/lvaccaro/proxychains)
- [screen](https://github.com/lvaccaro/screen)
- [screenfetch](https://github.com/lvaccaro/screenfetch)
- [secure-delete](https://github.com/lvaccaro/secure-delete)
- [simplescreenrecorder](https://github.com/lvaccaro/simplescreenrecorder)
- [software-properties-common](https://github.com/lvaccaro/software-properties-common)
- [squashfs-tools](https://github.com/lvaccaro/squashfs-tools)
- [subversion](https://github.com/lvaccaro/subversion)
- [swig](https://github.com/lvaccaro/swig)
- [synaptic](https://github.com/lvaccaro/synaptic)
- [tree](https://github.com/lvaccaro/tree)
- [tor](https://github.com/lvaccaro/tor)
- [torbrowser-launcher](https://github.com/lvaccaro/torbrowser-launcher)
- [vim](https://github.com/lvaccaro/vim)
- [wget](https://github.com/lvaccaro/wget)
- [xorriso](https://github.com/lvaccaro/xorriso)
